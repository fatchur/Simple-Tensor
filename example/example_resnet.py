...
image_size = 400
pretrained_model_path = 'pretrained/resnet/resnet-152/resnet_v2_152.ckpt'
result_model_path = 'result/resnet/model'
...
out, var_list = imrec.build_resnetv2(input_tensor=imrec.input_placeholder,
...
train_generator = imrec.batch_generator(batch_size=4, 
