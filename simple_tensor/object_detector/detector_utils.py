...
class ObjectDetector(object):
	...
	def yolo_loss(self, output, label):
		...
		for idx, i in enumerate(self.anchor):
			...
			ctr_loss = self.center_loss_alpha * (self.mse_loss((x_pred_real - self.grid_position_mask_onx * self.grid_width)/self.grid_width, (x_label_real - self.grid_position_mask_onx * self.grid_width)/self.grid_width) + 
												 self.mse_loss((y_pred_real - self.grid_position_mask_ony * self.grid_height)/self.grid_height, (y_label_real - self.grid_position_mask_ony * self.grid_height) /self.grid_height))
